...
type Props = NativeStackScreenProps<PersonalStackParams, 'WorkoutDetail'>;

export const PersonalWorkoutDetailScreen: React.FC<Props> = ({ route, navigation }) => {
  const { workoutId, clientName } = route.params;
          ...
          return (
            <Card key={ex.id || idx}>
              ...
              <View style={styles.chips}>
                ...
                {ex.restSeconds && <Chip icon="timer" label={`${ex.restSeconds}s`} />}
              </View>
